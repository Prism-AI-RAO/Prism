...
Rules:
- These are your primary interface to Prism's autonomous features. Do not attempt workarounds or alternative approaches.
...
/**
 * PromptBuilder assembles the system prompt for Prism agents.
 *
 * Two entry points:
 *
